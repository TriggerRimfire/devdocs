...
A plugin can simply add a new snippet file: `backend/attribute_columns` which contains all translations for the attributes:
```
<?php
...
class SwagAttribute extends Plugin
{
    public function install(InstallContext $context)
    {
        ...
        $service->update('s_user_addresses_attributes', 'my_column', TypeMapping::TYPE_STRING, [
            'displayInBackend' => true,
            'label' => 'My column default label',
            'supportText' => 'My column default support text',
            'helpText' => 'My column default help text'
...
s_user_addresses_attributes_my_column_label = "English label"
s_user_addresses_attributes_my_column_supportText = "English support text"
s_user_addresses_attributes_my_column_helpText = "English help text"
...
s_user_addresses_attributes_my_column_label = "Deutsches label"
s_user_addresses_attributes_my_column_supportText = "Deutscher support text"
s_user_addresses_attributes_my_column_helpText = "Deutscher help text"
```